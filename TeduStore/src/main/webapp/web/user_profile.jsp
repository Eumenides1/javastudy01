...
<div id="container" class="clearfix">
    ...
    <div id="leftsidebar_box" class="lf">
        ...
        <dl class="count_managment">
                ...
                <dd class="first_dd"><a href="profile.do">我的信息</a></dd>
                <dd><a href="password.do">安全管理</a></dd>
        </dl>
    </div>
    <!-- 右边栏-->
    <!--个人信息头部-->
        ...
        <div class="rs_content">
            ...
            <div class="rs_content_sex">
                ...
                <input type="radio"
                       ...
                       name="gender"
                       id="gender_male" value="1"/>男
                <input type="radio"
                        <c:if test="${user.gender == 0}">
                            checked="checked"
                        </c:if>
                       name="gender"
                       id="gender_female" value="0"/>女


                <!--以下2个是原有的使用图片完成的“选择性别”，已经隐藏-->
